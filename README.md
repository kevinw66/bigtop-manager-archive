...
3. Insert Test SQL Data in `dev-support/example/bigtop_manager`
...
6. Start bigtop-manager-ui `configure nodejs environmment, folder default is bigtop-manager-ui/node, then run with package.json`
...
2. Configure prometheus.yml to add below code into `scrape_configs`
```
